...
* @}
*/
#define SYSCFG_CFGR1_ADC_DMA_RMP ((uint16_t)0x0100)
#define SYSCFG_CFGR1_TIM16_DMA_RMP ((uint16_t)0x0800)
...
#define SYSCFG_DMARemap_ADC SYSCFG_CFGR1_ADC_DMA_RMP     /* Remap ADC DMA requests from channel1 to channel2 */
