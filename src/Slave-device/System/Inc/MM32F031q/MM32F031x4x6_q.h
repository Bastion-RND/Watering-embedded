...
/*!< [31:16]  Standard Peripheral Library main version */
#define __MM32F031x4x6_q_STDPERIPH_VERSION_MAIN   (0x01)
/*!< [15:8]   Standard Peripheral Library sub1 version */
#define __MM32F031x4x6_q_STDPERIPH_VERSION_SUB1   (0x00)
/*!< [7:0]   Standard Peripheral Library sub2 version */
#define __MM32F031x4x6_q_STDPERIPH_VERSION_SUB2   (0x00)
/*!< Standard Peripheral Library version number */
#define __MM32F031x4x6_q_STDPERIPH_VERSION       ((__MM32F031x4x6_q_STDPERIPH_VERSION_MAIN << 16)\
        | (__MM32F031x4x6_q_STDPERIPH_VERSION_SUB1 << 8)\
        | __MM32F031x4x6_q_STDPERIPH_VERSION_SUB2)
...
#define  RCC_CR_HSI_72M_EN                   ((uint32_t)0x01000000)        /*!< Internal High Speed clock output choice */
...
#define  RCC_CFGR_SW_HSI                     ((uint32_t)0x00000002)        /*!< HSI output selected as system clock */
...
#define  RCC_CFGR_SWS_HSI                    ((uint32_t)0x00000008)        /*!< HSI used as system clock */
...
#define  RCC_CFGR_MCO_HSI_DIV4               ((uint32_t)0x05000000)        /*!< Internal 12 MHz RC oscillator clock selected */
...
#define  RCC_APB2ENR_ADCEN                   RCC_APB2ENR_ADC1EN
...
#define ADDATA_CHANNELSEL_CH10              ((uint32_t)0x000A0000)               /*!<CHANNELSEL CH10*/
#define ADDATA_CHANNELSEL_CH11              ((uint32_t)0x000B0000)               /*!<CHANNELSEL CH11*/
...
#define ADDATA_CHANNELSEL_TempSenSor        ADDATA_CHANNELSEL_CH14               /*!<CHANNELSEL CH14*/
#define ADDATA_CHANNELSEL_VolSensor         ADDATA_CHANNELSEL_CH15               /*!<CHANNELSEL CH15*/
...
#define  ADCFG_SAMCTL                         ((uint32_t)0x00003C00)               /*!<ADC sample time select*/
...
#define  ADCFG_SAMCTL_OFFSET                  10
#define  ADCFG_SAMCTL_1_5                     ((uint32_t)0x0<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 1.5t*/
#define  ADCFG_SAMCTL_7_5                     ((uint32_t)0x1<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 7.5t*/
#define  ADCFG_SAMCTL_13_5                    ((uint32_t)0x2<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 13.5t*/
#define  ADCFG_SAMCTL_28_5                    ((uint32_t)0x3<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 28.5t*/
#define  ADCFG_SAMCTL_41_5                    ((uint32_t)0x4<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 41.5t*/
#define  ADCFG_SAMCTL_55_5                    ((uint32_t)0x5<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 55.5t*/
#define  ADCFG_SAMCTL_71_5                    ((uint32_t)0x6<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 71.5t*/
#define  ADCFG_SAMCTL_239_5                   ((uint32_t)0x7<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 239.5t*/
#define  ADCFG_SAMCTL_2_5                     ((uint32_t)0x8<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 2.5t*/
#define  ADCFG_SAMCTL_3_5                     ((uint32_t)0x9<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 3.5t*/
#define  ADCFG_SAMCTL_4_5                     ((uint32_t)0xA<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 4.5t*/
#define  ADCFG_SAMCTL_5_5                     ((uint32_t)0xB<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 5.5t*/
#define  ADCFG_SAMCTL_6_5                     ((uint32_t)0xC<<ADCFG_SAMCTL_OFFSET) /*!<ADC sample time select 6.5t*/
...
#define  ADCR_TRGSEL                          ((uint32_t)0x00000070)               /*!<TRGSEL[6:4]  ADC external trigger source select */
...
#define ADCHS_CHEN ((uint32_t)0x0000DFFF)   /*!<ADC channel select */
...
#define  ADCHS_CHEN12                         ((uint32_t)0x00001000)              /*!<ADC channel12 enable */
#define  ADCHS_CHEN14                         ((uint32_t)0x00004000)              /*!<ADC channel14 enable */
#define  ADCHS_CHEN15                         ((uint32_t)0x00008000)              /*!<ADC channel15 enable */
...
#define  UART_ISR_TXC_INTF                      ((uint16_t)0x0004)
...
#define DMA_Channel1_BASE      DMA1_Channel1_BASE
#define DMA_Channel2_BASE      DMA1_Channel2_BASE
#define DMA_Channel3_BASE      DMA1_Channel3_BASE
#define DMA_Channel4_BASE      DMA1_Channel4_BASE
#define DMA_Channel5_BASE      DMA1_Channel5_BASE


#define DMA_Channel1       DMA1_Channel1
#define DMA_Channel2       DMA1_Channel2
#define DMA_Channel3       DMA1_Channel3
#define DMA_Channel4       DMA1_Channel4
#define DMA_Channel5       DMA1_Channel5
...
#define SPI                 ((SPI_TypeDef *)SPI2_BASE)

#define RCC_APB2RSTR_ADCRST                 RCC_APB2RSTR_ADC1RST
#define RCC_APB1RSTR_SPIRST                 RCC_APB1RSTR_SPI2RST          /*!< SPI reset */
#define RCC_APB1RSTR_UARTRST                RCC_APB1RSTR_UART2RST         /*!< UART 2 reset */
#define RCC_APB1RSTR_I2CRST                 RCC_APB1RSTR_I2C1RST

#define RCC_AHBENR_DMAEN                    RCC_AHBENR_DMA1EN
#define RCC_AHBENR_FCEN                     RCC_AHBENR_FLITFEN
#define RCC_APB2ENR_ADCEN                   RCC_APB2ENR_ADC1EN            /*!< ADC interface clock enable */

#define RCC_APB2RSTR_TIM14EN                RCC_APB2ENR_TIM14EN
#define RCC_APB2RSTR_TIM16EN                RCC_APB2ENR_TIM16EN           /*!< TIM16 Timer clock enable */
#define RCC_APB2RSTR_TIM17EN                RCC_APB2ENR_TIM17EN           /*!< TIM17 Timer clock enable */
#define RCC_APB2RSTR_DBGMCUEN               RCC_APB2ENR_DBGMCUEN          /*!< Debug MCU clock enable */

#define RCC_APB1ENR_SPIEN                   RCC_APB1ENR_SPI2EN            /*!< SPI clock enable */
