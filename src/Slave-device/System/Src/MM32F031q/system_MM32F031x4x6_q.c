...
#elif defined SYSCLK_HSI_48MHz
	SystemCoreClock = SYSCLK_HSI_48MHz; /*!< System Clock Frequency (Core Clock) */
#elif defined SYSCLK_HSI_72MHz
    SystemCoreClock         = SYSCLK_HSI_72MHz;       /*!< System Clock Frequency (Core Clock) */
