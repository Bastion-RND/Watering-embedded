...
from receive_test.base import LoRaSpi #, LoRaGpioSX126x,
#import time
...
cs = Pin(11, mode=Pin.OUT, pull=Pin.PULL_UP, value=1)
spi = SPI(1, baudrate=8000000, polarity=0, phase=0, sck=Pin(14), miso=Pin(12), mosi=Pin(13))
LORA = LoRaSpi(spi, cs)

reset = Pin(10, mode=Pin.OUT, pull=Pin.PULL_UP, value=1)
busy = Pin(9, mode=Pin.IN)
dio1 = Pin(46, mode=Pin.IN)

buf = b'hex'
buf = LORA.transfer(buf)
print(buf)
