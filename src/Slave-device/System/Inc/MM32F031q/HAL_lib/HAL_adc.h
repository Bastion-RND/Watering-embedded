...
#define IS_ADC_ALL_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == ADC_BASE)

#define IS_ADC_DMA_PERIPH(PERIPH) (((*(uint32_t*)&(PERIPH)) == ADC_BASE)
...
#define ADC_ExternalTrigConv_EXTI_4 ((uint32_t)0x00020010)
#define ADC_ExternalTrigConv_EXTI_5 ((uint32_t)0x00020020)
...
#define IS_ADC_EXT_TRIG(REGTRIG) (((REGTRIG) == ADC_ExternalTrigConv_T1_CC1) ||     \
                                  ...
                                  ((REGTRIG) == ADC_ExternalTrigConv_EXTI_4) ||     \
                                  ((REGTRIG) == ADC_ExternalTrigConv_EXTI_5) ||     \
...
(CHANNEL) == ADC_Channel_12) || ((CHANNEL) == ADC_Channel_14) || \
(CHANNEL) == ADC_Channel_15) || ((CHANNEL) == ADC_Channel_All))
/**
* @}
*/
...
#define ADC_FLAG_AWD ((uint8_t)0x02) //ADWIF: Comparison Flag
#define ADC_FLAG_EOC ((uint8_t)0x01) //ADIF: Conversion End Flag
